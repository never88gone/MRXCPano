...
NSString *MRXCJSONErrorDomain = @"org.brautaset.JSON.ErrorDomain";


@implementation MRXCJsonBase
...
- (void)addErrorWithCode:(NSUInteger)code description:(NSString*)str {
    ...
    NSError *error = [NSError errorWitMRXComain:MRXCJSONErrorDomain code:code userInfo:userInfo];
